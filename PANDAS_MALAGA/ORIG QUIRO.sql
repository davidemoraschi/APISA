...
--============================================================================--
    ...
    BEGIN
      ...
      DELETE FROM OWN_KPI.KPI_QUI_N_INTERV where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
      ...
      exception when others then
          ...
          INSERT INTO OWN_KPI.KPI_ERRORES (fecha_error, KPI_NAME, error) VALUES (SYSDATE, 'QUI_N_INTERV', l_mensaje_error);
            UPDATE own_kpi.CONTROL_LANZAMIENTO SET fecha_fin=sysdate,PROCEDIMIENTO=('QUI_N_INTERV ERROR: '||l_mensaje_error) WHERE id=secuencia;
          COMMIT;
    ...
    BEGIN
      ...
      DELETE FROM OWN_KPI.KPI_QUI_N_INTERV_FIRM where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
      ...
      COMMIT;
       ...
       exception when others then
          ...
          l_mensaje_error := SUBSTR (DBMS_UTILITY.format_error_stack (), 1, 1999);
          INSERT INTO OWN_KPI.KPI_ERRORES (fecha_error, KPI_NAME, error) VALUES (SYSDATE, 'QUI_N_INTERV_FIRM', l_mensaje_error);
            UPDATE own_kpi.CONTROL_LANZAMIENTO SET fecha_fin=sysdate,PROCEDIMIENTO=('QUI_N_INTERV_FIRM ERROR: '||l_mensaje_error) WHERE id=secuencia;
          COMMIT;
    ...
    --Numero de intervenciones  programadas y realizadas en el ambito de hospitalizacion, con menos de 1 dia de estancia en el hospital.
        ...
        BEGIN
          ...
          DELETE FROM OWN_KPI.KPI_QUI_N_INTERV_MENOS_UNO where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
        ...
        exception when others then
              ...
              l_mensaje_error := SUBSTR (DBMS_UTILITY.format_error_stack (), 1, 1999);
              INSERT INTO OWN_KPI.KPI_ERRORES (fecha_error, KPI_NAME, error) VALUES (SYSDATE, 'QUI_N_INTERV_MENOS_UNO', l_mensaje_error);
                UPDATE own_kpi.CONTROL_LANZAMIENTO SET fecha_fin=sysdate,PROCEDIMIENTO=('QUI_N_INTERV_MENOS_UNO ERROR: '||l_mensaje_error) WHERE id=secuencia;
              COMMIT;
    ...
    DELETE FROM OWN_KPI.KPI_QUI_N_INTERV_FIRM_M_UNO where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
    ...
    exception when others then
          ...
          l_mensaje_error := SUBSTR (DBMS_UTILITY.format_error_stack (), 1, 1999);
          INSERT INTO OWN_KPI.KPI_ERRORES (fecha_error, KPI_NAME, error) VALUES (SYSDATE, 'QUI_N_INTERV_FIRM_M_UNO', l_mensaje_error);
            UPDATE own_kpi.CONTROL_LANZAMIENTO SET fecha_fin=sysdate,PROCEDIMIENTO=('QUI_N_INTERV_FIRM_M_UNO ERROR: '||l_mensaje_error) WHERE id=secuencia;
          COMMIT;
    ...
    DELETE FROM OWN_KPI.KPI_QUI_N_INTERV_CMA where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
    ...
    exception when others then
            ...
            l_mensaje_error := SUBSTR (DBMS_UTILITY.format_error_stack (), 1, 1999);
            INSERT INTO OWN_KPI.KPI_ERRORES (fecha_error, KPI_NAME, error) VALUES (SYSDATE, 'QUI_N_INTERV_CMA', l_mensaje_error);
            UPDATE own_kpi.CONTROL_LANZAMIENTO SET fecha_fin=sysdate,PROCEDIMIENTO=('QUI_N_INTERV_CMA ERROR: '||l_mensaje_error) WHERE id=secuencia;
            COMMIT;
    ...
    DELETE FROM OWN_KPI.KPI_QUI_N_INTERV_FIRM_CMA where fecha >= TRUNC(ADD_MONTHS(SYSDATE, -12),'MM');
