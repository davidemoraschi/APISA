EXEC ETL_LOAD_INGRESOS_DEL_DIA.P_001;
/

ALTER TABLE TEMP_CAMAS_A102048 ADD 
CONSTRAINT TEMP_CAMAS_A102048_R01
 FOREIGN KEY (NATID_UNIDAD_FUNCIONAL3)
 REFERENCES MSTR_MAE_UNIDADES_FUNCIONALES3 (NATID_UNIDAD_FUNCIONAL3)
 ENABLE
 VALIDATE
/

EXEC ETL_LOAD_INGRESOS_DEL_DIA.CREATE_SYNONYMS ('HUE40DAE');
/* Formatted on 4/24/2014 14:04:59 (QP5 v5.163.1008.3004) */
DROP TABLE TEMP_INGRESOS_B1;

CREATE TABLE TEMP_INGRESOS_B1
NOLOGGING
NOMONITORING
NOPARALLEL
AS
