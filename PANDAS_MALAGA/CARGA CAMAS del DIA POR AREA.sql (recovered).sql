...
ALTER TABLE TEMP_CAMAS_A1
 ADD (NATID_UNIDAD_FUNCIONAL3_RESP VARCHAR2(6), NATID_CONTROL_ENFERMERIA VARCHAR2(5), NATID_NUHSA  VARCHAR2(12), ETL_ERROR_DESCR VARCHAR2(250));
/
		...
		IF R1.NATID_EPISODIO > 0 THEN
			...
			IF v_REFERENCIA_ID > 0 THEN
				...
				IF v_USUARIO > 0 THEN
					...
					UPDATE TEMP_CAMAS_A1
						 SET NATID_NUHSA = v_NATID_NUHSA, NATID_UNIDAD_FUNCIONAL3_RESP = v_UNID_FUNC_RESP
					 WHERE NATID_EPISODIO = R1.NATID_EPISODIO;
				END IF;
			END IF;
		END IF;
