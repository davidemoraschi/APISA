...
BEGIN
   DBMS_SCHEDULER.DROP_JOB (job_name => 'ETL_LOAD_CATALOGO_P001');
END;

ALTER SESSION SET TIME_ZONE = 'Europe/Madrid';

BEGIN
   DBMS_SCHEDULER.create_job (job_name          => 'ETL_LOAD_CATALOGO_P001',
                              job_type          => 'PLSQL_BLOCK',
                              job_action        => 'BEGIN MSTR_SIGLO.ETL_LOAD_CATALOGO.P_001; END;',
                              ...
                              end_date          => NULL,
                              enabled           => TRUE,
                              comments          => 'Carga de jerarquía de CATALOGO desde replica de SIGLO');
END;