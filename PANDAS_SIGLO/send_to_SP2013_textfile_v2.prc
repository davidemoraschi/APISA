/* Formatted on 12/11/2013 14:39:26 (QP5 v5.163.1008.3004) PANDAS Copyright (c) 2013 -Davide Moraschi (davidem@eurostrategy.net)
Todos los derechos reservados. Prohibida su reproducción Total o Parcial. */
CREATE OR REPLACE PROCEDURE MSTR.send_to_SP2013_textfile_v2 (reportId IN VARCHAR2 DEFAULT '856B1A1A4A82A2A8A8BB8795E93AE208',
...
BEGIN
	...
	LOOP
		...
		UTL_HTTP.WRITE_RAW (l_http_request, DBMS_LOB.SUBSTR (v_txt, 2000, l_offset));
