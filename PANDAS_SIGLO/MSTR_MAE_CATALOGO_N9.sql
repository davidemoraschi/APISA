/* Formatted on 29/10/2013 14:09:11 (QP5 v5.163.1008.3004) */
...
AS
   SELECT ID NATID_CATALOGO_N9,
    ...
    WHERE     CLASIFICACION = 5
          AND ACTIVO = 'T'
          --AND VALORPADRE IN (SELECT NATID_CATALOGO_N8 FROM MSTR_MAE_CATALOGO_N8)
...
ALTER TABLE MSTR_MAE_CATALOGO_N9 ADD (
...
ALTER TABLE MSTR_SIGLO.MSTR_MAE_CATALOGO_N9 ADD
