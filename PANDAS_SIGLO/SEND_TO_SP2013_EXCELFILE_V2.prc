/* Formatted on 13/11/2013 15:15:35 (QP5 v5.163.1008.3004) PANDAS Copyright (c) 2013 -Davide Moraschi (davidem@eurostrategy.net)
Todos los derechos reservados. Prohibida su reproducción Total o Parcial. */
CREATE OR REPLACE PROCEDURE MSTR.send_to_SP2013_excelfile_v2 (reportId IN VARCHAR2 DEFAULT '856B1A1A4A82A2A8A8BB8795E93AE208',
...
BEGIN
	...
	p_url :=		'http://sp13pruebas.sas.junta-andalucia.es/_api/web/GetFolderByServerRelativeUrl(''/Documentos%20compartidos'')/Files/add(url='''
					 ...
					 || '.xlsx'',overwrite=true)';
	UTL_HTTP.set_transfer_timeout (300);
	l_http_request := UTL_HTTP.begin_request (p_url, PANDAS_095_SEND_TO_SHAREP.const_sharepoint_service_meth, PANDAS_095_SEND_TO_SHAREP.const_sharepoint_service_prot);
