/* Formatted on 27/05/2013 13:00:15 (QP5 v5.163.1008.3004) */
DROP TABLE MSTR_DET_SOLICITUDES_CON_CITA;

CREATE TABLE MSTR_DET_SOLICITUDES_CON_CITA
AS
   SELECT CODIGO_CITA,
          CODIGO_SOLICITUD,
          AREA_H,
          ...
          HORA_CITA,
          TO_DATE (FECHACITA || HORA_CITA, 'yyyy-mm-ddhh24:mi') FECHAHORACITA,
          ESTADOCITA,
          CENTRO_SOLICITANTE,
          UNIDAD_SOLICITANTE,
