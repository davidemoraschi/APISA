/* Formatted on 21/03/2013 13:08:00 (QP5 v5.163.1008.3004) */
DECLARE
   l_payload                                CLOB
      :=    '{ Título: "Copia de Seguridad", Cuerpo: "' --         || PANDAS_001_REPORT_EXECUTE_v4.return_grid_as_html ('QUIRO_DESARROLLO', 'CFC2C30F484F1C387C39938808BD6152')
