/* Formatted on 31/05/2013 11:41:28 (QP5 v5.163.1008.3004) */
CREATE OR REPLACE FORCE VIEW MSTR_UTL_SCHEDULER_JOB_LOG
AS
   SELECT l.log_id clave_primaria_log, l.job_name,
    ...
    WHERE l.Owner = USER /*AND l.job_name = 'ETL_LOAD_HISTO_CAMAS_P001' */AND l.log_id = r.log_id(+)
