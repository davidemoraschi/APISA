...
AS 
SELECT 
NULL,NULL,-1,-1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL
FROM DUAL
UNION ALL
SELECT CENTRO_ID,
       UNI_FUNCIONAL_ID,
  ...
  FROM REP_HIS_OWN.ADM_QRF_PQ_CAB@RND
       JOIN REP_HIS_OWN.ADM_QRF_PQ_DET@RND
          USING (PQ_CAB_ID)
       JOIN REP_HIS_OWN.ADM_QRF_IQ_PRE@RND
          USING (IQ_PRE_ID)
       JOIN (SELECT IQ_PRE_ID, CODIGO_ICD9, TEXTO_LIBRE
               FROM REP_HIS_OWN.ADM_QRF_IQ_ICD_PRE@RND
       ...
       JOIN (SELECT IQ_PRE_ID, CODIGO_PROC, TEXTO_LIBRE
          ...
          USING (IQ_PRE_ID)
       LEFT JOIN REP_HIS_OWN.ADM_QRF_IQ_DESPR@RND
          USING (IQ_DESPR_ID, IQ_PRE_ID)
       LEFT JOIN REP_HIS_OWN.ADM_QRF_IQ_X_LEQ@RND
          USING (IQ_PRE_ID)
...
CREATE INDEX IX01_PARTES_UNIDAD_FUNCIONAL ON MSTR_DET_PARTES_QUIRURGICOS
(NATID_UNIDAD_FUNCIONAL)
LOGGING
NOPARALLEL;

CREATE INDEX IX02_PARTES_FECHA_PARTE ON MSTR_DET_PARTES_QUIRURGICOS
(FHORA_INICIO_PARTE_QUIRU)
LOGGING
NOPARALLEL;

CREATE INDEX IX03_PARTES_QUIROFANO ON MSTR_DET_PARTES_QUIRURGICOS
(NATID_QUIROFANO)
LOGGING
NOPARALLEL;

CREATE UNIQUE INDEX MSTR_DET_PARTES_QUIRURGICOS_PK ON MSTR_DET_PARTES_QUIRURGICOS
