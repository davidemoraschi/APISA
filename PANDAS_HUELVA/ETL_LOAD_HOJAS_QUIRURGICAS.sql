DROP PACKAGE MSTR_QUIROFANO.ETL_LOAD_HOJAS_QUIRURGICAS;

CREATE OR REPLACE PACKAGE MSTR_QUIROFANO.ETL_LOAD_HOJAS_QUIRURGICAS
AS
   /******************************************************************************
...
/
DROP PACKAGE BODY MSTR_QUIROFANO.ETL_LOAD_HOJAS_QUIRURGICAS;
...
AS
   ...
   ******************************************************************************/
   ...
   BEGIN
      ...
      EXECUTE IMMEDIATE 'DROP INDEX IX04_HOJAS_NATID_EPISODIO';

      EXECUTE IMMEDIATE 'DROP INDEX IX05_HOJAS_NUHSA';

      EXECUTE IMMEDIATE 'DROP INDEX IX06_HOJAS_FECHA_HORA_PARTE';

      EXECUTE IMMEDIATE 'DROP INDEX IX07_HOJAS_CABECERA_PARTE';
      ...
      INSERT INTO MSTR_DET_HOJAS_QUIRURGICAS
         SELECT R_OBJECT_ID NATID_HOJA_QUIRURGICA,
                ...
                -1 NATID_QUIROFANO
           FROM REP_SIDCA_OWN.HCE_HOJA_QUIRURGICA@RND
      ...
      /* --Hay intervenciones con fecha parte diferente de la fecha intervencion
            UPDATE MSTR_DET_HOJAS_QUIRURGICAS
               SET FHORA_INICIO_PARTE_QUIRU =
                      (SELECT FECHA_HORA_INICIO
                         FROM HIS_OWN.ADM_QRF_PQ_CAB@RND
                        WHERE PQ_CAB_ID = (SELECT PQ_CAB_ID
                                             FROM HIS_OWN.ADM_QRF_PQ_DET@RND
                                            WHERE PQ_DET_ID = NATID_DETALLE_PARTE_QUIRU)),
      ...
      */
      ...
      EXECUTE IMMEDIATE 'CREATE INDEX IX04_HOJAS_NATID_EPISODIO ON MSTR_DET_HOJAS_QUIRURGICAS
        (NATID_EPISODIO)
        NOLOGGING
        NOPARALLEL';

      EXECUTE IMMEDIATE 'CREATE INDEX IX05_HOJAS_NUHSA ON MSTR_DET_HOJAS_QUIRURGICAS
        (NUHSA)
        NOLOGGING
        NOPARALLEL';

      EXECUTE IMMEDIATE 'CREATE INDEX IX06_HOJAS_FECHA_HORA_PARTE ON MSTR_DET_HOJAS_QUIRURGICAS
        (FHORA_INICIO_PARTE_QUIRU)
        NOLOGGING
        NOPARALLEL';

      EXECUTE IMMEDIATE 'CREATE INDEX IX07_HOJAS_CABECERA_PARTE ON MSTR_DET_HOJAS_QUIRURGICAS
        (NATID_CABECERA_PARTE_QUIRU)
        NOLOGGING
        NOPARALLEL';
