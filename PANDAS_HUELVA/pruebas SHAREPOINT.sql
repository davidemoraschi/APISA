/* Formatted on 20/03/2013 13:11:53 (QP5 v5.163.1008.3004) */
DECLARE
   l_payload                                VARCHAR2 (32767)
      := '{ Title: "Tre", Content: "POST HTML desde Oracle ' || TO_CHAR (SYSDATE, 'DD/MM HH24:MM') || '", Result: "SUCCESS"  }';
   x_content                                XMLTYPE;
  ...
  <s:Header>
    ...
    <o:Security s:mustUnderstand="1"
      ...
      <o:UsernameToken>
        <o:Username>admin@pandas.eurostrategy.net</o:Username>
        <o:Password>Toyotarecalls310</o:Password>
      </o:UsernameToken>
    </o:Security>
  </s:Header>
  <s:Body>
...
BEGIN
   ...
   l_http_request :=
      UTL_HTTP.BEGIN_REQUEST ('https://pandasbi.sharepoint.com/_forms/default.aspx?wa=wsignin1.0',
                              const_sharepoint_service_meth,
                              const_sharepoint_service_prot);
   ...
   */
   l_http_request :=
      UTL_HTTP.BEGIN_REQUEST ('https://pandasbi.sharepoint.com/_vti_bin/ListData.svc/PANDAS_ETL',
                              const_sharepoint_service_meth,
                              const_sharepoint_service_prot);
   UTL_HTTP.set_header (l_http_request, 'Cookie', FedAuth_cookie || '; ' || rtFa_cookie);
